...
RUBY_ROBOT_EVENTS = [ 
  WAVELET_BLIP_CREATED, WAVELET_BLIP_REMOVED,
  WAVELET_PARTICIPANTS_CHANGED, WAVELET_SELF_ADDED,
  WAVELET_SELF_REMOVED, WAVELET_TIMESTAMP_CHANGED,
  WAVELET_TITLE_CHANGED, WAVELET_VERSION_CHANGED, 
  BLIP_CONTRIBUTORS_CHANGED, BLIP_DELETED,
  BLIP_SUBMITTED, BLIP_TIMESTAMP_CHANGED,
  BLIP_VERSION_CHANGED, DOCUMENT_CHANGED,
  FORM_BUTTON_CLICKED
  ]
